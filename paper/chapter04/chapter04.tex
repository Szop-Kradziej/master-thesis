...
\begin{figure}[h]
    ...
    \caption{Interfejs studenta - lista dostępnych projektów (źródło własne).}
...
\begin{figure}[h]
    ...
    \caption{Interfejs studenta - widok projektu (źródło własne).}
...
\begin{figure}[h]
    ...
    \caption{Interfejs studenta - podgląd etapu (źródło własne).}
...
\begin{figure}[h]
    ...
    \caption{Interfejs studenta - podgląd wyników testów dla etapu (źródło własne).}
...
\begin{figure}[h]
    ...
    \caption{Interfejs studenta - podgląd integracji (źródło własne).}
...
\begin{figure}[h]
    ...
    \caption{Interfejs studenta - podgląd wyników testów dla integracji (źródło własne).}
