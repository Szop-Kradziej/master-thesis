...
Symulacji była na bieżąco monitorowana.
...
TODO Napisać i odnieść się do badania projektu historycznego

- Stwierdził że zdefiniowane etapy są bardzo sensowne a przypadki testowe dobrze dobrane

- Przy pierwszym etapie uznał że warto napisać poprawną implementację i parsowanie planszy ponieważ rzutuje ona na dalsze etapy

- Stwierdził ze to bardzo dobry etap

- Pozytywnie ocenił platformę

- Nie miał problemów z użytkowaniem platformy

- Oferowany przez platformę interfejs graficzny był dla nich zrozumiały

- Absolwent pisali kod inkrementacyjnie za każdym razem sprawdzając czy ich programy przechodzą przez przypadki testowe

- Platforma wykryłą regresję
