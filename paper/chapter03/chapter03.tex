...
TODO: Rev comment: Priorytetyzowaną listę etapów czy to zostało wyjaśnione?
TODO: Rev comment: dopisać, że wynikiem działania powinien być plik "czy to znaczy, wynikiem działania programu stud. musi być plik?"
TODO: Rev comment: Mam poczucie, że etapy i integracje nie zostały wystarczająco wyjaśnione (być może nie tu, tylko wcześniej)
