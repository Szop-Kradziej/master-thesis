\chapter{Wstęp}
\label{chapter:intro}
TODO: Nanieść uwagi dla całego rozdziału (nie wszystkie naniesione)
...
W~myśl tych dwóch założeń Agile przedkłada się ludzi i interakcje ponad narzędzia i~procesy oraz współpracę z klientem ponad negocjacje umów.
...
Opieranie nauki na prowadzeniu projektów grupowych jest zatem pożądanym trendem przystosowującym studentów do przyszłej pracy zawodowej.
Jednak wykonywanie zespołowych zadań niesie ze sobą wiele problemów.
Możemy wśród nich wyróżnić między innymi kłopoty z prawidłową oceną zespołu oraz poszczególnych członków oraz trudności związane z podtrzymywaniem motywacji.
