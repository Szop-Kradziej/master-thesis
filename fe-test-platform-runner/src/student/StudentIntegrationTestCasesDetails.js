...
import StudentIntegrationTestCaseRow from "./StudentIntegrationTestCaseRow";

class StudentIntegrationTestCasesDetails extends Component {
...
export default withStyles(styles)(StudentIntegrationTestCasesDetails);
