...
class UploadTestCaseFileDialog extends Component {
    ...
    handleUploadTestCaseFile = (event) => {
        ...
        data.append('file', this.inputTestCaseFile.files[0]);

        Api.uploadIntegrationTestCaseFile(this.props.projectName, this.props.integrationName, this.props.testCaseName, this.props.fileType, data)
...
export default withStyles(styles)(UploadTestCaseFileDialog);
