...
import StudentTestCaseRow from "./PreviewStudentTestCaseRow";
...
class PreviewStudentTestCasesDetails extends Component {
...
export default withStyles(styles)(PreviewStudentTestCasesDetails);
