...
class PreviewStudentUploadBinaryDialog extends Component {
    ...
    handleUploadStudentBinary = (event) => {
        ...
        return (
            <Dialog open={this.props.isOpen} onClose={this.props.closeActionHandler}
                ...
                <DialogActions>
                    ...
                    <Button onClick={this.handleUploadStudentBinary} color="primary">
                        Dodaj
                    </Button>
                </DialogActions>
            </Dialog>
...
export default withStyles(styles)(PreviewStudentUploadBinaryDialog);
